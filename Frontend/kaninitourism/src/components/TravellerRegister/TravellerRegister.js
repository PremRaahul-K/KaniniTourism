...
import TravelAgent from "../images/TravellerRegisterLogo.jpg";
import "../TravellerRegister/TravellerRegister.css";
...
function TravellerRegister() {
  ...
  const validateName = () => {
    if (/^[A-Za-z ]{2,}$/.test(user.userDetail.firstName)) {
      setNameError("");
      return true;
    } else {
      setNameError(
        "Last Name must contain at least 2 alphabetical characters."
      );
      return false;
    }
  };
  ...
  const validateAgencyName = () => {
    if (/^[A-Za-z ]{4,}$/.test(user.userDetail.agencyName)) {
      setAgencyError("");
      return true;
    } else {
      setAgencyError(
        "First Name must contain at least 4 alphabetical characters."
      );
      return false;
    }
  };
  ...
  const handleSubmit = () => {
    if (
      ...
      fetch("http://localhost:5115/api/Traveller/TravellerRegister", {
        method: "POST",
        headers: {
          accept: "text/plain",
  ...
  return (
    <div className="TravelAgentRegister">
      <div className="TravellerRegisterMessage">
        <div>
        ...
        <div className="LoginNote">
          ...
          <span className="SignInMessage">
            Explore your Dream Destination here
          </span>
        </div>
      </div>
      <div className="RegisterCredentials">
        <div className="UserCredentials">
          ...
          <div className="UserCredentials">
            <span className="SignInLabel">Traveller Register</span>
            <span className="SignInMessage">
          ...
          <div className="UserCredentials">
            ...
            <label className="RegisterInputLabel">First Name</label>
            <input
              type="text"
            ...
            <label className="RegisterInputLabel">Last Name</label>
            <input
              type="text"
